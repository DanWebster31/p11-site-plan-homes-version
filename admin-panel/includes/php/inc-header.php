...
<div id="headUnit">
  ...
  <div id="navBox">
    <ul>      
      <?php if ($_SESSION['userLevel'] == 1) { ?><li><a href="<?php print $p11base ?>users/" <?php $pos = strpos($loc, "users"); if ($pos === false) { echo ' '; } else { echo 'class="navLit"'; } ?>>Edit Users</a></li><?php } ?>
      <li><a href="<?php print $p11base ?>site-plan/" <?php $pos = strpos($loc, "site-plan"); if ($pos === false) { echo ' '; } else { echo 'class="navLit"'; } ?>>Site Plan</a></li>
      ...
      <li><a href="<?php print $p11base ?>cms/" <?php $pos = strpos($loc, "cms"); if ($pos === false) { echo ' '; } else { echo 'class="navLit"'; } ?>>CMS</a></li>
      <li><a href="<?php print $p11base ?>main/" <?php $pos = strpos($loc, "main"); if ($pos === false) { echo ' '; } else { echo 'class="navLit"'; } ?>>Home</a></li>
    </ul>
  </div>
</div>
</div>